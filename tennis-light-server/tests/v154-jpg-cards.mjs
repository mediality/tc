...
assert.match(styles, /Les cartes V163 sont des WebP sans transparence/);
...
console.log("v163 remplacement intégral des cartes JPG par WebP et bordure de masquage: OK");
