...
assert.match(app, /const GAME_VERSION = "v3\.20"/);
assert.match(html, /Tennis Courts Academy · <strong id="gameVersion">v3\.20<\/strong>/);
assert.match(html, /app\.js\?v=3\.20\.0/);
assert.match(html, /styles\.css\?v=3\.20\.0/);
