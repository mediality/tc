...
assert.match(app, /const GAME_VERSION = "v3\.30"/);
assert.match(html, /Tennis Courts Academy · <strong id="gameVersion">v3\.30<\/strong>/);
assert.match(html, /app\.js\?v=3\.30\.0/);
assert.match(html, /styles\.css\?v=3\.30\.0/);
