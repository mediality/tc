...
assert.equal(pkg.version, "2.169.31");
assert.match(app, /const GAME_VERSION = "v2\.169\.31"/);
assert.match(html, /Tennis Courts Academy · 2\.169\.31/);
assert.match(html, /app\.js\?v=170\.31/);
assert.match(html, /styles\.css\?v=170\.31/);
