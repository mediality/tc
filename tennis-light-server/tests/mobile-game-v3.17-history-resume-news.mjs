...
assert.match(app, /const GAME_VERSION = "v3\.17"/);
...
assert.match(mobile, /anchorPassButtonWhenItAppears/);
assert.match(mobile, /querySelector\("\[data-mobile-pass\]"\)\?\.scrollIntoView/);
...
console.log("Mobile v3.17 : historique, choix, plein écran, reprise et actualités : OK");
