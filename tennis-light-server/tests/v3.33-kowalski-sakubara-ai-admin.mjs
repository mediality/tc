...
assert.equal(pkg.version, "3.48.0");
...
assert.match(app, /const REMISE_UNDERLAY_IMAGE = "assets\/fond-carte-remise\.jpg\?v=3\.48"/);
...
console.log("v3.48 : nouveaux joueurs, profil, news, IA, RankIA, admin et finale multi-écrans : OK");
