...
assert.match(app, /const REMISE_UNDERLAY_IMAGE = "assets\/fond-carte-remise\.jpg\?v=3\.54"/);
...
console.log("v3.53 : nouveaux joueurs, profil, news, IA, RankIA, admin et finale multi-écrans : OK");
