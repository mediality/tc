...
assert.equal(pkg.version, "3.51.0");
...
assert.match(html, /class="lobby-footer"[\s\S]*v3\.51/);
...
assert.match(app, /const REMISE_UNDERLAY_IMAGE = "assets\/fond-carte-remise\.jpg\?v=3\.51"/);
...
console.log("v3.51 : nouveaux joueurs, profil, news, IA, RankIA, admin et finale multi-écrans : OK");
