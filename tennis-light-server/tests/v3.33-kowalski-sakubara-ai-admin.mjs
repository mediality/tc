...
assert.match(html, /class="lobby-footer"[\s\S]*v3\.52/);
...
assert.match(app, /const REMISE_UNDERLAY_IMAGE = "assets\/fond-carte-remise\.jpg\?v=3\.52"/);
...
console.log("v3.52 : nouveaux joueurs, profil, news, IA, RankIA, admin et finale multi-écrans : OK");
