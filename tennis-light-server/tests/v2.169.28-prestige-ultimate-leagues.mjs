...
assert.match(app, /const GAME_VERSION = "v3\.39"/);
assert.match(html, /Tennis Courts Academy · <strong id="gameVersion">v3\.39<\/strong>/);
assert.match(html, /styles\.css\?v=3\.39\.0/);
assert.match(html, /app\.js\?v=3\.39\.0/);
