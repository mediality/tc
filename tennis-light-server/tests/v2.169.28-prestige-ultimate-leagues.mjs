...
assert.match(app, /const GAME_VERSION = "v3\.37"/);
assert.match(html, /Tennis Courts Academy · <strong id="gameVersion">v3\.37<\/strong>/);
assert.match(html, /styles\.css\?v=3\.37\.0/);
assert.match(html, /app\.js\?v=3\.37\.0/);
...
assert.doesNotMatch(css, /animation: exchange-winner-halo \.55s/);
