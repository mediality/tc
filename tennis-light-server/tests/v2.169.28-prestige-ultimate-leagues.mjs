...
assert.match(app, /const GAME_VERSION = "v3\.34"/);
assert.match(html, /Tennis Courts Academy · <strong id="gameVersion">v3\.34<\/strong>/);
assert.match(html, /styles\.css\?v=3\.34\.0/);
