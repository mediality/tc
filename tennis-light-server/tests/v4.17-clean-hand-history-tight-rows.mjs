...
assert.match(html, /styles\.css\?v=4\.17\.0/);
assert.match(html, /app\.js\?v=4\.17\.0/);
...
assert.match(css, /\.hand \.card-actions button:not\(:disabled\)[\s\S]*?border:\s*2px solid #f6c344/);
