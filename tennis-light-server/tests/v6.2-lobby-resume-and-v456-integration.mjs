...
assert.match(index, /Tennis Courts Academy · <span>V6\.10<\/span>/);
assert.match(index, /styles\.css\?v=6\.10\.0/);
assert.match(index, /mobile-game\.css\?v=6\.10\.0/);
assert.match(index, /app\.js\?v=6\.10\.0/);
assert.match(index, /mobile-game\.js\?v=6\.10\.0/);
