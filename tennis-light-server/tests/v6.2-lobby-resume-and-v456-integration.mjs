...
assert.match(index, /styles\.css\?v=6\.19\.0/);
assert.match(index, /mobile-game\.css\?v=6\.19\.0/);
assert.match(index, /app\.js\?v=6\.19\.0/);
assert.match(index, /mobile-game\.js\?v=6\.19\.0/);
