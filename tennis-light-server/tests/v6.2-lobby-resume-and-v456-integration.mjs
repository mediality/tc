...
assert.match(index, /Tennis Courts Academy · <span>V6\.13<\/span>/);
assert.match(index, /styles\.css\?v=6\.13\.0/);
assert.match(index, /mobile-game\.css\?v=6\.13\.0/);
assert.match(index, /app\.js\?v=6\.13\.0/);
assert.match(index, /mobile-game\.js\?v=6\.13\.0/);
