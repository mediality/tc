...
assert.match(html, /mobile-game\.css\?v=170\.37/);
assert.match(html, /mobile-game\.js\?v=170\.37/);
...
assert.match(mobileApp, /window\.addEventListener\("orientationchange", \(\) => renderMobileGame\(false\)\)/);
