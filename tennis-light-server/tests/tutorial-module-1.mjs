...
assert.match(htmlSource, /id="openTutorialModulesButton"[^>]*data-required-role="admin"/);
assert.match(htmlSource, /data-tutorial-module="basics"/);
assert.match(appSource, /querySelectorAll\("\[data-tutorial-module\]"\)/);
