...
assert.match(html, /Tennis Courts Academy · <span>V5\.20<\/span>/);
assert.match(html, /ultimate-card-data\.js\?v=5\.20\.0/);
...
assert.match(app, /if \(ULTIMATE_MODE\.active\) return "";[\s\S]*data-next-set-exchange/);
