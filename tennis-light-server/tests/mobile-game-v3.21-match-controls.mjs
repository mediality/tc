...
assert.match(mobile, /querySelector\("#mobileTurnTop"\)\?\.scrollIntoView\(\{ block: "start", behavior: "auto" \}\)/);
...
console.log("Mobile v3.21 : tour adverse automatique et sécurité Passer : OK");
